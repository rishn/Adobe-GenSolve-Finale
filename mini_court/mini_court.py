...
class MiniCourt():
    def __init__(self,frame):
        self.drawing_rectangle_width = 250 // 2
        self.drawing_rectangle_height = 500 // 2
        self.buffer = 50 // 2
        self.padding_court=20 // 2
    ...
    def convert_meters_to_pixels(self, meters):
        return convert_meters_to_pixel_distance(meters,
                                                constants.DOUBLE_LINE_WIDTH // 2,
                                                self.court_drawing_width // 2
                                            )
    ...
    def convert_bounding_boxes_to_mini_court_coordinates(self,player_boxes, ball_boxes, original_court_key_points ):
        ...
        for frame_num, player_bbox in enumerate(player_boxes):
            ...
            if list(player_bbox.keys()) == []:
                player_bbox = present_player_box
            ...
            present_player_box = player_bbox
            ...
            for player_id, bbox in player_bbox.items():
                ...
                max_player_height_in_pixels = max(bboxes_heights_in_pixels) if bboxes_heights_in_pixels else max_player_height_in_pixels
    ...
    def draw_points_on_mini_court(self,frame,postions, color=(0,255,0)):
        for _, position in postions.items():
            x,y = position
            x= int(x)
            y= int(y)
