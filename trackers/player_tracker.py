...
class PlayerTracker:
    ...
    def choose_and_filter_players(self, court_keypoints, player_detections):
        ...
        chosen_player = self.choose_players(court_keypoints, player_detections_first_frames)
    ...
    def choose_players(self, court_keypoints, player_dict):
        ...
        for track_id, bbox in player_dict.items():
            ...
            min_distance = min(abs(player_center[1] - court_keypoints[1]), abs(court_keypoints[5] - player_center[1]))
            if player_center[0] < court_keypoints[0] or player_center[0] > court_keypoints[4]:
